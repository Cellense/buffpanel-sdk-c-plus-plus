...
```
BuffPanel::Client::track(game_token, player_token, is_existing_player, attributes, [callback]);
```
...
```
BuffPanel::Client::track(game_token, player_tokens, is_existing_player, attributes, new MyCallback());
```
